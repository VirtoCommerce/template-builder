...
import { App } from './app';
import { PreviewMessagesService } from './services/preview-messages.service';
import { BuilderMessagesService } from './services/builder-messages.service';
...
export class ServiceLocator {
    ...
    private static _previewMessages;
    private static _builderMessages;
    ...
    static getPreviewMessages(): PreviewMessagesService {
        return this._previewMessages || (this._previewMessages = new PreviewMessagesService());
    }

    static getBuilderMessages(): BuilderMessagesService {
        return this._builderMessages || (this._builderMessages = new BuilderMessagesService(Environment.DesignerUrl));
    }
