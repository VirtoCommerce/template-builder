...
| Component library | Angular Material 16 (MDC-based) |
...
## Angular Material 16 — MDC Migration Notes

Angular Material 15+ migrated all components to MDC-based implementations. This changes internal DOM structure vs the old non-MDC components.
